...
export const Spotlight = ({
  ...
  return (
    <div className="pointer-events-none absolute inset-0 h-full w-full z-[-1]">
      {/* FUNDO PRETO REMOVIDO PARA DAR LUGAR AO UNICORN */}
      {/* <div className="absolute inset-0 bg-black/80 z-[-3]" /> */}
      
      {/* GRID REMOVIDO PARA UNIFICAR NO HERO */}
      {/* <GridBackground /> */}
      
      {/* SPOTLIGHTS - FICA POR CIMA */}
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
    ...
    <div
      ...
      style={{
        backgroundImage: `url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' 
          ...
          stroke='rgb(255 255 255 / 0.1)'%3e%3cpath d='M0 .5H31.5V32'/%3e%3c/svg%3e")`,
      }}
    />
  );
};