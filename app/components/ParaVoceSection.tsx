...
export function ParaVoceSection() {
   return (
      <section className="relative w-full py-16 md:py-24 bg-black border-y border-white/5">
         <div className="max-w-6xl mx-auto px-6">

            {/* COMPACT HEADER */}
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
               <div className="space-y-4">
                  <div className="text-[10px] font-black tracking-[0.3em] uppercase text-purple-500">Segmentação // 02</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-white/10 border border-white/10 overflow-hidden rounded-2xl">
               ...
               <div className="md:col-span-2 bg-black p-8 md:p-12 flex flex-col justify-between group">
                  <div>
